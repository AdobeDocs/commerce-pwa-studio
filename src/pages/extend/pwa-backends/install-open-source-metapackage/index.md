---
title: Extend the Magento Open Source backend
---
...
# Extend the Magento Open Source backend

While PWA uses the standard GraphQL workflow, the Magento Open Source metapackage adds capabilities for some extra PWA Studio features.

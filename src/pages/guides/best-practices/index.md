...
- Use [CSS modules](/guides/general-concepts/css-modules/index.md) to separate and package your custom styles. This allows you to:
...
The PWA Studio [extensibility framework](/guides/general-concepts/extensibility/index.md) should be used to customize the default Venia storefront.
